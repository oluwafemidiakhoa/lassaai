...
We developed **LassaAI**, an XGBoost early-warning model trained on NCDC national Weekly Epidemiological Reports (national weekly series, 2020–2025; 313 weeks, 6,456 confirmed cases). On a strict out-of-time 2024 hold-out, LassaAI reached AUROC = 0.880 (precision 0.93, recall 0.78) for anticipating weeks of elevated national transmission ~4 weeks ahead — a modest but genuine ~0.03 gain over a naive four-week-average baseline (AUROC 0.849), driven chiefly by dry-season timing. The model is deployed as a free, open-source dashboard (https://www.gailabai.com/lassa) with all code and data publicly available (https://github.com/oluwafemidiakhoa/lassaai, MIT licence). All metrics are retrospective. **The critical unresolved question is whether LassaAI's predictions — issued before outcomes are known — add operational value over trivial seasonal baselines in prospective use.**
