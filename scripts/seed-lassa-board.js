  ...
  try {
    ...
    forecastItem = {
      ...
      metadata: {
        ...
        summary: `Forecast generated by LassaAI outbreak prediction model (XGBoost, AUROC 0.9994). All 37 Nigerian states currently LOW risk (wet season). High-risk season: November through April.`,
        dataPoints: 27861,
        note: 'Retrospective model — prospective validation in progress. See gailabai.com/lassa for live dashboard.',
      },
    };
